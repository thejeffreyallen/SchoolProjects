...
public interface LibraryInterface {
	...
	/**
	 * Get a copy of the books ArrayList, not a reference to the internal books
	...
	/**
	 * Takes a Book object as a parameter and adds it to the internal ArrayList of
	 * Books.
	 * 
	...
	/**
	 * Return string containing a list of the books in the library including their
	 * cooresponding index position within the ArrayList.
	 * 
	 ...
	 * Format: title, author, genre, filepath
	 * 
