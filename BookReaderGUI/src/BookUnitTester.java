		...
		try {
			...
			if (value.equals(author)) {
				...
				if (value.equals(newAuthor)) {
					...
					testResults += subTestFailure(subtest, "Author should be " + newAuthor,
							"Author returned is " + value);
					testPassed = false;
				}
			} else {
			...
			if (value.equals(filename)) {
				...
				testResults += subTestFailure(subtest, "Filename should be " + filename,
						"Filename returned is " + value);
				testPassed = false;
			}
